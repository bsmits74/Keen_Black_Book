...
\par
The Input Manager maintains several tables to translate the scancodes to ASCII\footnote{American Standard Code for Information Interchange.} codes
\begin{itemize}
	\item Unshifted ASCII codes.
	\item Shifted ASCII codes.
	\item ASCII codes for the 14 duplicate keys (\cw{E0h} prefix).
\end{itemize}
