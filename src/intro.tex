...
\begin{itemize}
  \item The video adapter (called EGA) did not support any form of scrolling. Nor did it support any form of sprites, which allowed movement of something on the screen by simply updating their \cw{(x,y)} coordinates.
