...
\begin{itemize}
  ...
  \item BIOS data address \cw{40h:40h} holds the disk motor shutoff counter. It is decremented by the original timer interrupt and once the value reaches 0 the disk motor will be shut down.
\end{itemize}
