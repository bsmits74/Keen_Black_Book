...
The audio system is complex because of the fragmentation of audio devices it can deal with. At a high level, the Sound Manager offers a lean API divided in two categories: one for sounds and one for music.\\
...
\begin{figure}[H]
  \centering
  \includegraphics[width=0.7\textwidth]{imgs/drawings/pc_speaker.eps}
