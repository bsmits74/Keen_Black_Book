...
The \cw{spritetable[]} contains beside width and height in bytes also information on the sprite center, hit boundaries and number of shifted sprites (this will be explained in section \ref{section:draw_sprites}, page \pageref{section:draw_sprites}). \\
