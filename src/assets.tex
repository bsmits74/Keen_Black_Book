...
\par
The \cw{spritetable[]} includes not only width and height but also information on the sprite's center, hitbox, and number of bit shifts (explained section "\nameref{section:drawing_sprites}" on page \pageref{section:drawing_sprites}). \\
...
The game supports a maximum of 100 maps. The \cw{tileinfo[]} array contains properties data for each tile.
