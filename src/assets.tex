...
\par
id Software intended Keen Dreams to include music for the Sound Blaster and Sound Source devices. In fact, Bobby Prince composed the song "You've Got to Eat Your Vegetables!!" for the game's introduction. HHowever, Softdisk Publishing wanted Keen Dreams to fit on a single 360KiB floppy disk, and in order to do this, id Software had to scrap the game's music at the last minute\footnote{https://vimeo.com/4022128, at 2:00-4:55.}. The team did not even have time to remove the music setup menu.\\


\begin{figure}[H]
\centering
\fbox{\includegraphics[width=1.0\textwidth]{screenshots_300dpi/music.png}}
\caption{Music setup in Keen Dreams, even though the game contains no music.}
\end{figure}
...
\begin{figure}[H]
\centering
\fbox{\includegraphics[width=1.0\textwidth]{screenshots_300dpi/sound_header.png}}
...
The MUSE tool packed all sound effects together in a compressed \cw{SOUND} archive and generated \cw{HEAD} and \cw{DICT} files and a \mbox{C header} file with asset IDs.\\
...
\par
All these features, and no damn cut and paste! For a fuckin' 
year!!! (But i'm not bitter ... ) \\
\par
\textbf{Tom Hall\protect\footnotemark}
\end{fancyquotes}\\
\addtocounter{footnote}{-1}
\stepcounter{footnote}
\footnotetext{Tom Hall, The Doom Bible (http://5years.doomworld.com/doombible/).}
