...
\item The framebuffer (the VRAM) made of four memory banks with a minimum of 16KiB (rather than one bank of 64KiB). Via memory expansion each memory bank could be upgraded to 32KiB or 64KiB (resulting in 128KiB or 256KiB total VRAM). The original model from IBM came with 16KiB per memory bank, but almost all other EGA cards were equipped with the full 64KiB per memory bank\footnote{PC Tech Journal Oct 1986 (page 82-83) and Nov 1986 (page 148-149)}. 
...
When calculating the intended value in the 64-color EGA palette, the binary number of the intended entry is of the form "rgbRGB" where a lowercase letter is the least significant bit of the channel intensity (\(\frac{1}{3}\) color intensity) and an uppercase letter is the most significant bit of intensity (\(\frac{2}{3}\) color intensity). The more intensity, the brighter the color is. For example, \cw{02h} will produce green, \cw{10h} will produce dim green and \cw{12h} will produce bright green. The color magenta is created by setting both "R" and "B", which is color code \cw{05h}. Each of the 16 color indexes could be reassigned to one color from the "rgbRGB" palette.\\
...
\rowcolor{CGA_Black}\rowstyle{\color{white}} 00h & Black          & 000000           & 0 	\\ \hline
\rowcolor{CGA_Blue} 01h & Blue          & 000001           & 1   			\\ \hline
\rowcolor{CGA_Green} 02h & Green          & 000010           & 2   			\\ \hline
\rowcolor{CGA_Cyan} 03h & Cyan          & 000011           & 3   			\\ \hline
\rowcolor{CGA_Red} 04h & Red          & 000100           & 4   				\\  \hline
\rowcolor{CGA_Magenta} 05h & Magenta          & 000101           & 5   		\\ \hline
\rowcolor{CGA_Brown} 06h & Brown          & 010100           & 20   		\\ \hline
\rowcolor{CGA_Light_Grey} 07h & Light grey          & 000111           & 7   		\\ \hline
\rowcolor{CGA_Dark_Grey} 08h & Dark grey          & 111000           & 56   		\\ \hline
\rowcolor{CGA_Bright_Blue}\rowstyle{\color{black}} 09h & Bright blue          & 111001           & 57   			\\ \hline
\rowcolor{CGA_Bright_Green} 0Ah & Bright green          & 111010           & 58   			\\ \hline
\rowcolor{CGA_Bright_Cyan} 0Bh & Bright cyan          & 111011           & 59   			\\ \hline
\rowcolor{CGA_Bright_Red} 0Ch & Bright red          & 111100           & 60   				\\ \hline
\rowcolor{CGA_Bright_Magenta} 0Dh & Bright magenta          & 111101           & 61   		\\ \hline
\rowcolor{CGA_Bright_Brown} 0Eh & Yellow          & 111110           & 62   		\\ \hline
\rowcolor{CGA_White} 0Fh & White          & 111111           & 63   		\\ \hline
\end{tabularx}
\end{table}
