...
\begin{itemize}
  ...
  \item the horizontal fine tuning is then adjusted by \cw{(x \% 8)} using horizontal pel panning
\end{itemize}
...
\addtocounter{footnote}{-1}
\stepcounter{footnote}
\footnotetext{Same interview with Lex Fridman in 2022.}
...
\begin{figure}[H]
\centering
 \scaledimage{0.7}{/game/Scroll_KC4_6_1.png}
