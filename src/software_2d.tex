...
\par
The source code for the first three episodes of Commander Keen is not publicly available, but thanks to reverse engineering\footnote{Chocolate Keen is a reverse engineering of Commander Keen in C and SDL. The goal is to be super accurate versus the original, see https://github.com/jamesfmackenzie/chocolatekeen} the ATR algorithm could be explained in detail.
...
\begin{figure}[H]
\centering
 \includegraphics[width=0.9\textwidth]{screenshots_300dpi/game/Keen_ATR_1-3_a.png}
...
\begin{figure}[H]
\centering
 \includegraphics[width=0.89\textwidth]{screenshots_300dpi/game/Keen_ATR_1-3_b.png}
...
Combining the background and foreground layers involves an \cw{AND}-bitwise operator clearing the background and the \cw{OR}-bitwise operator to write the foreground layer.\\
