...
\end{figure}
Now, if the screen is again scrolling to the top-left one can see why there is a need for the 2\textsuperscript{nd} row in the buffer. After this cycle the \cw{*update[otherpage]} is cleared and resetted as shown in the last illustration of Figure \ref{fig:screen_setup}.\\
\pagebreak
