...
\begin{itemize}
  ...
  \end{itemize}
  \item \cw{updatestart[]} points to the tile buffer array. It maintains which tiles needs to be updated upon next refresh. There are two tile buffer arrays; one for the screenpage and one for otherpage.
