...
\begin{figure}[H]
\centering
\includegraphics[width=0.8\textwidth]{imgs/drawings/Tile_Refresh.eps}
...
The code verifies if any of the virtual pages is between the addresses \cw{0xC400} and \cw{0xFFFF} and, if this is the case, copies the entire VRAM to the opposite side.\\
