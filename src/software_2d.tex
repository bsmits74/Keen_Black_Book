...
Now, let's have a closer look at the EGA memory setup. In the file \cw{id\_vw.h} the virtual screen in VRAM is defined by SCREENSPACE, which is set to 512x240 pixels (64x240 bytes). This is more than sufficient since the visible screen in mode \cw{0x0D} is 320x200 pixels.\\
