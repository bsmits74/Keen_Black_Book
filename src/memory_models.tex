...
\caption{Tiny memory model layout, total of 64 KiB.}
\label{fig:mm_tiny}
\end{figure}
...
\caption{Compact memory model layout, data can be larger than 64KiB.}
...
\caption{Large memory model layout, code and data can be larger than 64KiB.}
\label{fig:mm_large}
\end{figure}
...
\caption{Huge memory model layout, code and global data can be larger than 64KiB.}
\label{fig:mm_large}
\end{figure}
